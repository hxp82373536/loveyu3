       ...
       this.state={
           ...
           option:{
               ...
               series: [{
                   ...
                   smooth: 0.4,
                   color: ['#ff0'],
                   data: [100, 300, 500, 300, 200, 200, 100, 200]
               }, {
                   name: '总量',
                   type: 'line',
                   symbol: 'none',
                   smooth: 0.5,
                   color: ['#f00'],
                   data: [800, 1200, 1400, 1200, 700, 900, 900, 1400]
               }]
           }
           }
       }
                ...
                <Sider style={{backgroundColor:"#deeeff"}}>
                    ...
                    <Layout>
                        <Row>
                            <Col span={15}>
                                <div>
                                    <ReactEcharts option={this.state.option} style={{height: "350px",backgroundColor:"#e6e6e6",width:"100%"}}/>
                                </div>
